...
try:
    ...
    MERCADOPAGO_PREFERENCE_EXPIRATION_HOURS = 24
_mp_expiration_minutes_raw = os.environ.get("MP_PREFERENCE_EXPIRATION_MINUTES", "").strip()
if _mp_expiration_minutes_raw:
    try:
        MERCADOPAGO_PREFERENCE_EXPIRATION_MINUTES = int(_mp_expiration_minutes_raw)
    except ValueError:
        MERCADOPAGO_PREFERENCE_EXPIRATION_MINUTES = MERCADOPAGO_PREFERENCE_EXPIRATION_HOURS * 60
else:
    MERCADOPAGO_PREFERENCE_EXPIRATION_MINUTES = MERCADOPAGO_PREFERENCE_EXPIRATION_HOURS * 60
try:
    MERCADOPAGO_EXPIRATION_SWEEP_MINUTES = int(os.environ.get("MP_EXPIRATION_SWEEP_MINUTES", "10"))
except ValueError:
    MERCADOPAGO_EXPIRATION_SWEEP_MINUTES = 10
try:
...
UNFOLD = {
    ...
    "SITE_URL": os.environ.get("SITE_URL", "https://cracktcg.com/"),
